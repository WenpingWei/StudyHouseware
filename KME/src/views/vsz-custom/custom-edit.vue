    ...
    <div class="contain-content">
      <div class="left-add">
        <div class="add-header">
          ...
          >编辑客户</el-button>
          <el-button class="filter-item" type="primary" style="border-radius: 0;" v-else>新增客户</el-button>
        </div>
        <div class="add-content">
          ...
          >
            <el-form-item label="客户名称:" prop="customerName">
              <el-input v-model="listQuery.customerName"></el-input>
            </el-form-item>
            <el-form-item label="联系电话:" prop="telephone">
              <el-input v-model="listQuery.telephone"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getListData: function(cid) {
      ...
      var cid = cid;
      this.$ajax({
        url: $$(`/custom/customer?id=${cid}`),
        method: "get"
      }).then(data => {
        that.listQuery.id = cid;
        that.listQuery.customerName = data.data.data.customerName;
        that.listQuery.telephone = data.data.data.telephone;
        that.listQuery.email = data.data.data.email;
        that.listQuery.address = data.data.data.address;
        that.listQuery.mark = data.data.data.mark;
        that.listQuery.latitude = data.data.data.latitude;
        that.listQuery.longitude = data.data.data.longitude;
        that.listQuery.attachId = data.data.data.attachId;
        that.listQuery.imgDataUrl = process.env.VUE_APP_BASE_API +data.data.data.path;
        that.listQuery.sysName = data.data.data.sysName;
        that.mapShow();
        that.listQuery = this.listQuery
      });
    },
    //地图
    mapShow: function() {
