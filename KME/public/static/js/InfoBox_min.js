...
(function () {
  ...
  var c = BMapLib.InfoBox = function (f, e, d) {
    ...
    this._opts.closeIconDisplay = d.closeIconDisplay ||"block";
  ...
  c.prototype.getOffset = function () {
    ...
    _getCloseIcon: function () {
      var d = "<img src='" + this._opts.closeIconUrl + "' align='right' style='position:absolute;right:0px;cursor:pointer;margin:" + this._opts.closeIconMargin + ";display:" +this._opts.closeIconDisplay +"'/>";
      return d
    },
